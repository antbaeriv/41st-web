package com.fortyfirst.orbat.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.fortyfirst.orbat.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.fortyfirst.orbat.repository.UserRepository.USERS_BY_EMAIL_CACHE);
