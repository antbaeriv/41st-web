...
import { TroopersComponent } from 'app/entities/troopers/troopers.component';
...
describe('Component Tests', () => {
  describe('Troopers Management Component', () => {
    let comp: TroopersComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(TroopersComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.troopers[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
